...
artifact_dir="${SROBOTIS_TEST_ARTIFACT_DIR:-${SROBOTIS_OUTPUT_ROOT:-$PWD/output}/test-artifacts/lerobot_app/${SROBOTIS_TEST_NAME:-act-dummy-inference}}"
...
log_file="$log_dir/act_dummy_inference.log"
